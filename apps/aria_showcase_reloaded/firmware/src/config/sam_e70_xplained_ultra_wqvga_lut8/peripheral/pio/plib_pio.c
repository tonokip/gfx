...
void PIO_Initialize ( void )
{
   ...
   ((pio_registers_t*)PIO_PORT_A)->PIO_ABCDSR[0]= 0x00000000;
   ((pio_registers_t*)PIO_PORT_A)->PIO_ABCDSR[1]= 0x00100000;
   /* PORTA PIO Disable and Peripheral Enable*/
   ((pio_registers_t*)PIO_PORT_A)->PIO_PDR = ~0xFFEE7FE7;
   ...
   ((pio_registers_t*)PIO_PORT_C)->PIO_PDR = ~0xC00B7E00;
   ...
   ((pio_registers_t*)PIO_PORT_D)->PIO_ABCDSR[0]= 0x00000000;
   ((pio_registers_t*)PIO_PORT_D)->PIO_ABCDSR[1]= 0x2083E000;
   /* PORTD PIO Disable and Peripheral Enable*/
   ((pio_registers_t*)PIO_PORT_D)->PIO_PDR = ~0xDF7C1FFF;
